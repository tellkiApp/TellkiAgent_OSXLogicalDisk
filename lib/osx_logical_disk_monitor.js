...
metrics['iused'] =   { retrieveMetric: 1, id: '2123:Used Inodes:4',     get: function(t) { return parseInt(t[5], 10); } };
metrics['ifree'] =   { retrieveMetric: 1, id: '2124:Free Inodes:4',     get: function(t) { return parseInt(t[6], 10); } };
metrics['i%used'] =  { retrieveMetric: 1, id: '2125:% Used Inodes:6',   get: function(t) { return ((parseInt(t[5], 10)/(parseInt(t[5], 10) + parseInt(t[6], 10)))*100).toFixed(2); } };
